...
#                                             Main Logic
# ==================================================================================================
input_dirpath="${root_dirpath}/${LAMBDA_API_DIRNAME}"

# Golang
go_output_dirpath="${root_dirpath}/${GOLANG_DIRNAME}/${LAMBDA_BINDINGS_DIRNAME}"
...
# TypeScript
typescript_output_dirpath="${root_dirpath}/${TYPESCRIPT_DIRNAME}/src/${LAMBDA_BINDINGS_DIRNAME}"
